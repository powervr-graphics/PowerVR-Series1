...
;*  RCS info:
;*
;*  $Date: 1997/09/09 18:12:54 $
;*  $Revision: 1.9 $
;*  $Locker:  $
;*  $Log: dtexml.asm,v $
;; Revision 1.9  1997/09/09  18:12:54  erf
;; Insured that max UVs not zero.
;;
;; Revision 1.8  1997/05/13  17:37:21  erf
;; Changed functions _PackTSPTex and _PackTSPMipMapTex to __PackTSPTex and
;; __PackTSPMipMapTex.
;;
;; Revision 1.7  1997/04/17  16:55:05  sxy
;; Removed texapi stuff
;;
;; Revision 1.6  1997/04/17  15:14:15  sxy
;; Added assembly versions of pixel packing routines for
;; texture api
;;
...
_PackTSPMipMapTexInAsm	PROC NEAR
	...
	PUBLIC   __PackTSPMipMapTex
__PackTSPMipMapTex	PROC NEAR
endif
